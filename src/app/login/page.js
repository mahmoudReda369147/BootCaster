    ...
    import { loginWithEmailPassword, loginWithGoogle } from "@/lib/loginFunc";
    ...
    export default function LoginPage() {
        ...
        return (
            <PublicRoute>
                <div className="min-h-screen bg-gradient-to-br pt-13 from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300">
                            ...
                            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <button
                                            type="button"
                                            className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm bg-white dark:bg-gray-700 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors duration-200 cursor-pointer"
                                            onClick={async () => {
                                                try {
                                                    const user =
